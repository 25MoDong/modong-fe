    ...
    <>
      {clusters.map((item) => {
        ...
        return item.isCluster ? (
          ...
          >
            {
              /* 선택 로직: 2~5 -> cluster1.svg, 6~10 -> cluster2.svg, 11+ -> cluster3.svg */
            }
            <div
            ...
            >
              <img
                src={
                  (item.count >= 2 && item.count <= 5) ? '/clusters/cluster1.svg' :
                  (item.count <= 10) ? '/clusters/cluster2.svg' : '/clusters/cluster3.svg'
                }
                alt={`cluster-${item.count}`}
                draggable={false}
