      ...
      <div className="px-[20px] pt-[16px] pb-[24px]">
        ...
        <div className="mt-[12px] relative">
          <input
            ...
            className="w-full h-[44px] pl-[16px] pr-[40px] text-[14px] placeholder:text-[#9CA3AF]
                       border border-[#E5E7EB] rounded-full"
          />
          <FiSearch className="absolute right-[12px] top-1/2 -translate-y-1/2 text-gray-400" size={18} />
        </div>

        {/* 스탬프 카드 */}
        <div className="relative mt-[20px]">
          {/* 돌멩이 (지름 56px) */}
          <div className="absolute -top-[28px] right-[16px] w-[56px] h-[56px] rounded-full bg-[#E5E7EB] grid place-items-center">
          ...
          >
            ...
            <div className="mt-[6px] flex items-end justify-between">
              <p className="text-[36px] leading-[36px] font-extrabold tracking-[-0.3px]">00개</p>
            ...
            >
              ...
              <div className="p-[10px]">
                <div className="flex items-center justify-between">
                  <p className="body-13 font-semibold truncate max-w-[115px]">어나더굿뉴스</p>
        ...
        {/* 오늘의 추천 */}
        <h2 className="mt-[24px] text-[16px] leading-[20px] font-semibold">오늘의 추천</h2>

        {/* 카테고리 (높이 24px) */}
        <div className="mt-[8px] flex gap-[8px]">
          {["흐림", "비가주륵주륵", "28도"].map((c) => (
            <button key={c} className="px-[10px] h-[24px] rounded-full bg-[#F3F4F6] text-[11px] text-[#6B7280]">
              {c}
            </button>
          ))}
        </div>
        ...
        <div className="mt-[12px] grid grid-cols-3 gap-[12px]">
          {[1, 2, 3].map((i) => (
            <div key={i} className="rounded-card bg-brand-cream border border-brand-accent/20 overflow-hidden">
